...
const nmspace = 'random_balloon_colours';
const changeStallBalloonColourKey = nmspace + ".changeStallBalloonColour"
const changePeepBalloonColourKey = nmspace + ".changePeepBalloonColour"
...
const showWindow = function() {
    const window = ui.getWindow(nmspace);
    if (window) {
      window.bringToFront();
      return;
    }
